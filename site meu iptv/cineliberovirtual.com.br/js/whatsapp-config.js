...
const PHONE_NUMBER = '5521967827833'; // Número com código do país (sem + no início)
const DEFAULT_MESSAGE = 'Ol%C3%A1%2C+gostaria+de+experimentar+a+Viu+TV+Plus.'; // Mensagem URL encoded
